...
<head>
    ...
    <title>Initial Core Inspection</title>
<head>
<body>
    ...
    ?>
            <tr>
                ...
                <td>
                    <a href="physical/edit_inspection.php?id=<?php echo $row['id']; ?>" class="link-dark"><i class="fa-solid fa-pen-to-square fs-5 me-3"></i></a>
                    <a href="physical/view_inspection.php?id=<?php echo $row['id']; ?>" class="link-dark"><i class="fa-solid fa-eye fs-5 me-3"></i></a>
                    <?php if (!isset($_SESSION['form_submitted']) || !$_SESSION['form_submitted']) { ?>
                        <a href="physical/add_inspection.php?id=<?php echo $row['id']; ?>" class="btn btn-dark addButton" id="addButton_<?php echo $row['id']; ?>">Add</a>
                    <?php } ?>
                </td>
            </tr>
    <?php
