...
<body>
    ...
    ?>
            <tr>
                ...
                <td>
                    <a href="engine/edit_eng.php?id=<?php echo $row['id']; ?>" class="link-dark"><i class="fa-solid fa-pen-to-square fs-5 me-3"></i></a>
                    <a href="engine/view_eng.php?id=<?php echo $row['id']; ?>" class="link-dark"><i class="fa-solid fa-eye fs-5 me-3"></i></a>
                    <?php if (!isset($_SESSION['form_submitted']) || !$_SESSION['form_submitted']) { ?>
                        <a href="engine/add_eng.php?id=<?php echo $row['id']; ?>" class="btn btn-dark addButton" id="addButton_<?php echo $row['id']; ?>">Add</a>
                    <?php } ?>
                </td>
            </tr>
    <?php
