...
<body>
    <nav class="navbar navbar-light bg-light justify-content-center fs-3 mb-5">
        Alternator Remanufacturing Process
    </nav>
    ...
    ?>
            <tr>
                ...
                <td>
                    <a href="alternator/edit_alternator.php?id=<?php echo $row['id']; ?>" class="link-dark"><i class="fa-solid fa-pen-to-square fs-5 me-3"></i></a>
                    <a href="alternator/view_alternator.php?id=<?php echo $row['id']; ?>" class="link-dark"><i class="fa-solid fa-eye fs-5 me-3"></i></a>
                    <?php if (!isset($_SESSION['form_submitted']) || !$_SESSION['form_submitted']) { ?>
                        <a href="alternator/add_alternator.php?id=<?php echo $row['id']; ?>" class="btn btn-dark addButton" id="addButton_<?php echo $row['id']; ?>">Add</a>
                    <?php } ?>
                </td>
            </tr>
    <?php
